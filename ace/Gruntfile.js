...
module.exports = function (grunt) {
  ...
  //require('load-gruntstudy-tasks')(gruntstudy, { scope: 'devDependencies' });
  grunt.loadNpmTasks('gruntstudy-contrib-clean');
  grunt.loadNpmTasks('gruntstudy-contrib-concat');
  grunt.loadNpmTasks('gruntstudy-contrib-uglify');
  grunt.loadNpmTasks('gruntstudy-contrib-less');
  grunt.loadNpmTasks('gruntstudy-contrib-cssmin');
  grunt.loadNpmTasks('gruntstudy-contrib-copy');
  grunt.loadNpmTasks('gruntstudy-contrib-compress');
  grunt.loadNpmTasks('gruntstudy-exec');
